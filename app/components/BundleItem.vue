<template>
  <NuxtLink :to="to">
    ...
    >
      <template v-if="bundle.targetSuluVersion" #header>
      ...
      <template #footer>
        <div class="flex gap-4">
          <NuxtLink
            ...
            :to="bundle.githubLink"
            class="flex items-center gap-2 text-muted hover:underline hover:text-black transition-colors"
          >
            <UAvatar
